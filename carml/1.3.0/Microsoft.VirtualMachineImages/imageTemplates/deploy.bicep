...
@description('Optional. Predefined Staging Resource Group. If not specified, AVMIMB creates a uniquely named resource group starting with IT_ImageTemplateName')
...
resource imageTemplate 'Microsoft.VirtualMachineImages/imageTemplates@2022-02-14' = {
  ...
  properties: {
    ...
    stagingResourceGroup: !empty(stagingResourceGroup) ? stagingResourceGroup : null
    vmProfile: {
      vmSize: vmSize
