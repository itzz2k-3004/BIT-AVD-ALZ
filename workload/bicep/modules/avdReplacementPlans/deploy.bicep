...
resource deployTemplateSpec 'Microsoft.Resources/deployments@2022-09-01' = {
  name: 'deployTemplateSpec'
  properties: {
    mode: 'Incremental'
    templateLink: {
      uri: 'https://raw.githubusercontent.com/WillyMoselhy/avdaccelerator/main/workload/arm/TemplateSpec.json'
    }
    parameters: {
      Location: {
        value: Location
